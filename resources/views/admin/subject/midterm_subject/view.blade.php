              ...
              <div class="card-body">
                <div class="row">
                  ...
                  <div class="form-group col-md-3">
                    ...
                    <a href="{{ route('midterm.nursery.subject.view',[$getClassName->id, $getTermName->id]) }}" class="btn btn-success" style="margin-top: 32px;">Refresh</a>
                  </div>
...
<script type="text/javascript">
    $(document).ready(function() {
      ...
      $('.editGoalBtn').click(function() {
          ...
          $('#editGoalModal form').attr('action', '/admin/midterm/nursery_subjects/view/' + goalId);
