        ...
        <div class="col-md-12">
          ...
          <div class="card">
            <div class="card-header">
              <h3 class="card-title">Search Submitted Home Fun</h3>
            </div>
              ...
              <div class="card-body">
                <div class="row">
                  ...
                  <div class="form-group col-md-2">
                    ...
                    <a href="{{ route('homework.submitted',[$homework_id]) }}" class="btn btn-success" style="margin-top: 32px;">Refresh</a>
                  </div>
          ...
          <div class="card">
            <div class="card-header">
              <h3 class="card-title">Submitted Home Fun List</h3>
            </div>
