        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form method="POST" action="{{ route('cbt.assign.store', $getRecord->id) }}">
                @csrf
                <div class="card-body">
                        ...
                        @foreach ($getClass as $class)
                            <div>
                                <label style="font-weight: normal">
                                    <input type="checkbox" value="{{ $class->id }}" name="class_id[]" id="">{{ $class->name }} {{ $class->description }}
                                </label>
                            </div>
                        @endforeach
                  </div>
