...
<div class="content-wrapper">
  ...
  <section class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-9">
          <h1>Assigned CBT List: <small style="color: brown;">({{ $getRecord->count() }} Total CBT Exams Assigned So Far)</small></h1>
        </div>
              ...
              <div class="card-body">
                <div class="row">
                  ...
                  <div class="form-group col-md-3">
                    ...
                    <a href="{{ route('cbt.assigned.list') }}" class="btn btn-success" style="margin-top: 32px;">Refresh</a>
                  </div>
                ...
                <tbody>
                  @foreach ($getRecord as $value)
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('cbt.assigned_list.edit', [$value->id]) }}" class="btn btn-sm btn-primary">Edit</a>

                                <form action="{{ url('admin/cbt/assign/delete/'.$value->id) }}" method="POST" class="d-inline-block delete-form">
                                    @csrf
                                    @method('DELETE')
