    ...
    $id = 1
                                                ...
                                                @forelse ($getRecord as $cbt)
                                                    <tr>
                                                        ...
                                                        <td style="min-width: 200px">{{ $cbt->term_name }} {{ $cbt->term_session }}</td>
                                                        ...
                                                        <td style="min-width: 110px;">
                                                            <a href="{{ route('cbt.assign', $cbt->id) }}"
                                                            ...
                                                            <div class="dropdown">
                                                                ...
                                                                <div class="dropdown-menu"
                                                                    ...
                                                                    <a class=" d-inline-block dropdown-item badge badge-success text-white mb-1"
                                                                        href="{{ route('cbt.edit', $cbt->id) }}">Edit</a>

                                                                    <a class="d-inline-block dropdown-item badge badge-primary text-white mb-1"
                                                                        href="{{ route('cbt.view_questions', $cbt->id) }}">View
                                                                        Questions</a>


                                                                    {{-- DELETE BUTTON FROM CHATGPT --}}
                                                                    {{-- <form action="{{ route('cbt.delete', $cbt->id) }}"
                                                                        method="POST" class="d-inline">
                                                                        @csrf
                                                                        @method('DELETE')
                                                                        <button class="dropdown-item badge badge-danger text-white mb-1"
                                                                            type="submit"
                                                                            onclick="return confirm('Are you sure you want to delete this exam?');">Delete
                                                                            CBT</button>
                                                                    </form> --}}

                                                                    <form action="{{ route('cbt.delete', $cbt->id) }}" method="POST"
                                                                        class="d-inline">
                                                                        @csrf
                                                                        @method('DELETE')
            ...
            <!-- Edit Modal -->
            <div class="modal fade" id="editGoalModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
                aria-hidden="true">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                        ...
                        <form method="POST" action="">
                            ...
                            <div class="modal-body">
                                <div class="form-group">
                                    {{-- <label for="recipient-name" class="col-form-label">Class Name: {{ $getClassName->name }} {{
                                        $getClassName->description }}</label>
                                    <input type="hidden" name="class_id" value="{{ $getClassName->id }}"> --}}
                                </div>

                                <div class="form-group">
                                    {{-- <label for="recipient-name" class="col-form-label">Term Name: {{ $getTermName->name }} {{
                                        $getTermName->session }}</label>
                                    <input type="hidden" name="exam_id" value="{{ $getTermName->id }}"> --}}
                                </div>

                                <div class="form-group">
                                    <label for="message-text" class="col-form-label">Enter Subject Goal <span
                                            style="color: red;">*</span> </label>
