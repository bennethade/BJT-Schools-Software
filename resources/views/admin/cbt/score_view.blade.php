                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <a href="{{ route('cbt.score.view') }}" class="btn btn-success"
                                                ...
                                                @if (!empty($getAllWrittenCBT) && !empty($getAllWrittenCBT->count()))
                                                    @forelse ($getAllWrittenCBT as $value)
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <a href="{{ route('cbt.score.list', [Request::get('class_id'), Request::get('exam_id'), $value->cbt_exam_id]) }}"
                                                                    class="btn btn-info">View Scores</a>
                                                            </td>
                                                        </tr>
