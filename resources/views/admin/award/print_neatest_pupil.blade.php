...
<body>
    <div class="certificate">
        ...
        <div class="sub-title">NEATEST PUPIL AWARD</div> <br>
        ...
        <div class="description motto">for being the NEATEST pupil in <span style="text-transform: uppercase"> {{ $getClass->name }}</span>  <br> for <span style="text-transform: uppercase"> {{ $getExam->name }} {{ $getExam->session }} </span></div>
        ...
        <div class="signature">
            ...
            {{-- <div class="watermark">
                <img src="{{ $getSetting->getTrophy() }}" alt="Trophy Watermark">
            </div> --}}
