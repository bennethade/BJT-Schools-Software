               ...
               <div class="card-body">
                  <div class="row">
                     ...
                     <div class="form-group col-md-3">
                        ...
                        <a href="{{ route('award.view') }}" class="btn btn-success" style="margin-top: 32px;">Refresh</a>
                     </div>
                  </div>
               </div>
            </form>
                                            ...
                                            <form action="" method="POST">
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="min-width: 180px;">
                                                        ...
                                                        <a href="{{ route('award.view.single', [Request::get('class_id'), Request::get('exam_id'), $value->id]) }}" class="btn btn-sm btn-warning">View Award</a>
                                                    </td>
