...
<body>
    <div class="certificate">
        ...
        <div class="sub-title">EARLY BIRD AWARD</div> <br>
        ...
        <div class="description motto">for being the MOST PUNCTUAL pupil in <span style="text-transform: uppercase"> {{ $getClass->name }}</span>  <br> for <span style="text-transform: uppercase"> {{ $getExam->name }} {{ $getExam->session }} </span></div>
