                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-md-3">
                            ...
                            <select name="title" id="" class="form-control" required>
                                ...
                                <option {{ (old('title') == 'Mr and Mrs') ? 'selected' : '' }} value="Mr and Mrs">Mr and Mrs</option> 
                            </select>
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" class="form-control" name="mobile_number" required placeholder="Mobile Number" value="{{ old('mobile_number') }}">
                            <div style="color: red;">{{ $errors->first('mobile_number') }}</div>
                        </div>

                        <div class="form-group col-md-6">
                            <label>Address <span style="color: red">*</span> </label>
                            <input type="text" class="form-control" name="address" required placeholder="Address" value="{{ old('address') }}">
