                                          ...
                                          <tr>
                                             ...
                                             @foreach ($getSubject as $subject)
                                                @php
                                                   ...
                                                   if(!empty($getMark))
                                                   {
                                                      $totalMark = $getMark->class_work  + $getMark->home_work + $getMark->test + $getMark->exam;
                                                   }
                                                ...
                                                <td>
                                                   <div style="margin-bottom: 15px;">
                                                      ...
                                                      CA 1
                                                      <input type="number" name="mark[{{ $i }}][class_work]" id="class_work_{{ $student->id }}{{ $subject->subject_id }}" style="width: 130px;" placeholder="CW" value="{{ !empty($getMark->class_work) ? $getMark->class_work : '' }}" class="form-control">
                                                   </div>

                                                   <div style="margin-bottom: 15px;"> 
                                                      CA 2                                                       
                                                      <input type="number" name="mark[{{ $i }}][home_work]" id="home_work_{{ $student->id }}{{ $subject->subject_id }}" style="width: 130px;" placeholder="HW" value="{{ !empty($getMark->home_work) ? $getMark->home_work : '' }}" class="form-control">
                                                   </div>

                                                   <div style="margin-bottom: 15px;">  
                                                      
                                                      CA 3 
                                                      <input type="number" name="mark[{{ $i }}][test]" id="test_{{ $student->id }}{{ $subject->subject_id }}" style="width: 130px;" placeholder="Test" value="{{ !empty($getMark->test) ? $getMark->test : '' }}" class="form-control">
                                             ...
                                             <td style="min-width: 250px;">
                                                ...
                                                <a class="btn btn-primary" style="margin-top: 60px;" target="_blank" href="{{ url('admin/my_exam_result/print?exam_id=' . Request::get('exam_id') . '&student_id='.$student->id) }}">Print</a>
