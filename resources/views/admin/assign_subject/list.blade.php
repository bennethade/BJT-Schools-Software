               ...
               <div class="card-body">
                  <div class="row">
                     ...
                     <div class="form-group col-md-3">
                        ...
                        <a href="{{ route('assign_subject.list') }}" class="btn btn-success" style="margin-top: 32px;">Refresh</a>
                     </div>
                  </div>
               </div>
               <!-- /.card-body -->
                        ...
                        <tbody>
                           ...
                           <tr>
                              ...
                              <td style="min-width: 250px;">
                                 ...
                                 <a href="{{ route('assign_subject.edit_single', [$value->id]) }}" class="btn btn-warning btn-sm">Edit Single</a>
                                 <a href="{{ route('assign_subject.mass_edit', [$value->id]) }}" class="btn btn-primary btn-sm">Mass Edit</a>


                                 <form action="{{ url('admin/assign_subject/delete/'.$value->id) }}" method="POST" class="d-inline-block delete-form">
                                    @csrf
                                    @method('DELETE')
