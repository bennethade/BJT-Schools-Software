        ...
        <div class="container-fluid">
            <div class="row mb-2">
                @if(!empty($getStudent))
                    ...
                    <div class="col-sm-6">
                        <a href="{{ url('teacher/ptc/print_single?class_id=' . $getSingleClassName->id . '&exam_id=' . $getSingleExamName->id . '&student_id=' . $getStudent->student_id) }}" class="btn btn-sm btn-warning" style="float: right;" target="_blank">Print PTC</a>
                    </div>
                @endif
            </div>
        </div>
