                                       ...
                                       <form action="" method="POST" class="SubmitForm" id="SubmitForm">
                                          ...
                                          <tr>
                                             ...
                                             <td style="min-width: 250px;">
                                                ...
                                                <a href="{{ route('teacher.ptc.view_single',[Request::get('class_id'), Request::get('exam_id'), $student->id]) }}" class="btn btn-sm btn-warning" style="margin-top:30px;">View PTC</a>
...
////FOR MULTIPLE SAVE BUTTON
   $(document).ready(function() {
        ...
        $(document).on('click', '.SaveSingleSubject', function(e) {
            ...
            $.ajax({
                type: "POST",
                url: "{{ url('teacher/ptc/single_submit_ptc') }}",
                data: {
                "_token": "{{ csrf_token() }}",
                // id: id,
