...
<div class="content-wrapper">
   ...
   <section class="content-header">
      <div class="container-fluid">
         <div class="row mb-2">
            <div class="col-sm-6">
               <h1>Marks Register <span style="color:red">(Form Teachers Only)</span></h1>
            </div>
         </div>
      </div>
      <!-- /.container-fluid -->
                                          ...
                                          <tr>
                                             ...
                                             @foreach ($getSubject as $subject)
                                                ...
                                                <td>
                                                   ...
                                                   <div style="margin-bottom: 15px;">
                                                      CA Comment
                                                      <textarea name="mark[{{ $i }}][ca_comment]" id="ca_comment_{{ $student->id }}{{ $subject->subject_id }}" cols="" rows="4" placeholder="CA Comment" class="form-control">{{ !empty($getMark->ca_comment) ? $getMark->ca_comment : '' }}</textarea>
                                                   </div>
                                             ...
                                             <td style="min-width: 250px;">
                                                ...
                                                <a class="btn btn-success" style="margin-top: 60px;" target="_blank" href="{{ url('teacher/my_exam_result/print?exam_id=' . Request::get('exam_id') . '&student_id='.$student->id) }}">Exam Result</a>

                                                <br>
                                                   <a class="btn btn-warning" style="margin-top: 60px;" target="_blank" href="{{ url('teacher/my_ca_result/print?exam_id=' . Request::get('exam_id') . '&student_id='.$student->id) }}">C.A Result</a>
