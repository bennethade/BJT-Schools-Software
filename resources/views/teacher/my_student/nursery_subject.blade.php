  ...
  <section class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        ...
        <div class="col-sm-3" style="text-align: right;">
          <button type="button" class="btn btn-primary" id="addGoal">Add New Learning Objective</button>
        </div>
              ...
              <div class="card-body">
                <div class="row">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" class="form-control" name="name" placeholder="Search Objective Here" value="{{ Request::get('name') }}">
                    </div>
                    ...
                    <td colspan="100%">
                      <p style="color: red">
                        No Subjects added to this class for this term. Kindly click on the <span style="color: blue">"Add New Subject Goal"</span> button at the top to start adding subjects one after the oher. 
                          Or better still, click on the <span style="color: blue">"Import Learning Objectives"</span> button to automatically add all learning objectives to this class for this term.
                      </p>
                    </td>
                  @endforelse
                </tbody>
...
<!-- Add A single Subject Goal Modal -->
...
<!-- Edit A single Subject Goal Modal -->
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $('.editGoalBtn').click(function() {
            ...
            $('#editGoalModal form').attr('action', '/teacher/nursery_subjects/view/' + goalId);
