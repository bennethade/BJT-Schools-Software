                ...
                <div class="card" style="padding: 20px;">
                    ...
                    <div class="row" style="text-align: center">
                        @foreach ($getExam as $exam)
                            <a class="btn btn-danger" href="{{ route('teacher.assign_student.student_list',[$className->id, $exam->exam_id]) }}" style="margin: 10px; padding:10px;">{{ $exam->exam_name }} {{ $exam->exam_session }}</a>
                            {{-- <a class="btn btn-danger" href="{{ route('teacher.assign_student.student_list',[$className->id, $exam->id]) }}" style="margin: 10px; padding:10px;">{{ $exam->name }} {{ $exam->session }}</a> --}}
