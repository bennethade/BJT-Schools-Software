        ...
        <div class="col-sm-12">
          <h1> 
            ...
            @if ($getClassName->class_section == 'Nursery School')
              <a href="{{ route('teacher.midterm.nursery.subject.view',[$getClassName->id, $getExamName->id]) }}" class="btn btn-warning btn-sm" style="margin-left: 50px;">Mid-Term Learning Objectives</a>

              <a href="{{ route('teacher.nursery.subject.view',[$getClassName->id, $getExamName->id]) }}" class="float-right btn btn-primary btn-sm">{{ $getExamName->name }} Exam L. Objectives</a>
            @endif
          ...
          <div class="card-body">
            <div class="row">
              ...
              <div class="form-group col-md-3">
                ...
                <a href="{{ route('teacher.assign_student.student_list',[$getClassName->class_id, $getExamName->id]) }}" class="btn btn-success" style="margin-top: 32px;">Refresh</a>
              </div>
    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <div class="col-md-12">
                        ...
                        <tbody>
                            ...
                            @forelse ($getSearchStudent as $value)
                                ...
                                <td style="min-width: 150px;">
                                    <a href="{{ url('teacher/assign_student/' . $getClassName->class_id . '/' . $getExamName->id . '/' . $value->id) }}" class="btn btn-primary btn-sm">Assign To {{ $getClassName->class_name }}</a>
                                </td>
                                </tr>
                            @empty
                                <td colspan="100%">
          ...
          <div class="card">
            <div class="card-header">
              <h3 class="card-title">List Of Students Already Assigned To {{ $getClassName->class_name }} {{ $getClassName->description }} Class</h3>
            </div>
            <!-- /.card-header -->
            <div class="card-body p-0" style="overflow: auto;">
              <table class="table table-striped">
                  ...
                  @foreach ($getRecord as $value)
                    <tr>
                      ...
                      <td style="min-width: 300px;">
                        <a href="{{ route('teacher.assign_student.edit.student', [$value->student_id]) }}" class="btn btn-sm btn-primary">Edit Data</a>
                        
                        @if ($getClassName->class_section == 'Nursery School')
                          
                        @else
                          <a href="{{ url('teacher/student-subject/view_subjects/' . $getClassName->class_id . '/' . $getExamName->id . '/' . $value->student_id) }}" class="btn btn-sm btn-warning">View Subjects</a>
                        @endif
                        
                        <a href="{{ url('teacher/assign_student/remove/' . $getClassName->class_id . '/' . $getExamName->id . '/' . $value->student_id) }}" class="btn btn-sm btn-danger">Remove</a>
