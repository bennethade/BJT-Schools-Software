            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    <div class="container-fluid">
                        <div class="row mb-2">
                            <div class="col-sm-9">
                                <h1 style="">Subject Teacher CBT Exams</h1>
                            </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-3">
                                        ...
                                        <a href="{{ route('subject_teacher.cbt.view.all') }}" class="btn btn-success" style="margin-top: 32px;">Refresh</a>
                                    </div>
                                </div>
                            </div>
                            <!-- /.card-body -->
                                                    ...
                                                    @forelse ($getRecord as $cbt)
                                                        <tr>
                                                            ...
                                                            <td style="min-width: 110px;">
                                                                <a href="{{ route('subject_teacher.cbt.assign', $cbt->id) }}"
                                                                ...
                                                                <div class="dropdown">
                                                                    ...
                                                                    <div class="dropdown-menu"
                                                                        ...
                                                                        <a class=" d-inline-block dropdown-item badge badge-success text-white mb-1"
                                                                            href="{{ route('subject_teacher.cbt.edit', [$cbt->id, Request::get('class_id')]) }}">Edit</a>
            ...
            <div class="modal fade" id="addCBTModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <form action="{{ route('teacher.cbt.submit') }}" method="POST">
                            {{ csrf_field() }}
