      ...
      <div class="container-fluid">
         <div class="card">
            <div class="card-header">
               <h3 class="card-title">Search Marks Entry</h3>
            </div>
                                          ...
                                          <tr>
                                             ...
                                             @foreach ($getSubject as $subject)
                                                ...
                                                <td>
                                                   ...
                                                   <div style="margin-bottom: 15px;">
                                                      Comment
                                                      <textarea readonly name="mark[{{ $i }}][teacher_remark]" id="teacher_remark_{{ $student->id }}{{ $subject->subject_id }}" cols="" rows="5" placeholder="Subject Comment" class="form-control">{{ !empty($getMark->teacher_remark) ? $getMark->teacher_remark : '' }}</textarea>
                                                   </div>
                                             ...
                                             <td style="min-width: 250px;">
                                                ...
                                                {{-- <a class="btn btn-success" style="margin-top: 60px;" target="_blank" href="{{ url('teacher/my_exam_result/print?exam_id=' . Request::get('exam_id') . '&student_id='.$student->id) }}">Print Result</a> --}}
