...
<div class="content-wrapper">
   ...
   <section class="content-header">
      <div class="container-fluid">
         <div class="row mb-2">
            <div class="col-sm-6">
               <h1>Marks Register <span style="color:red; font-size:16px;">(Form Teachers Only)</span></h1>
            </div>
         </div>
      </div>
      <!-- /.container-fluid -->
               ...
               <div class="card-body">
                  <div class="row">
                     ...
                     <div class="form-group col-md-3">
                        ...
                        <a href="{{ route('teacher.marks_register') }}" class="btn btn-success" style="margin-top: 32px;">Refresh</a>
                     </div>
                  </div>
               </div>
               <!-- /.card-body -->
               ...
               <div class="card">
                  ...
                  <div class="card-body p-0" style="overflow: auto;">
                     <table class="table table-striped">
                        ...
                        <div style="margin-bottom: 15px;">
                        CA Comment
                        <textarea name="mark[{{ $i }}][ca_comment]" id="ca_comment_{{ $student->id }}{{ $subject->subject_id }}" cols="" rows="3" placeholder="CA Comment" class="form-control">{{ !empty($getMark->ca_comment) ? $getMark->ca_comment : '' }}</textarea>
                        </div>
                        <div style="margin-bottom: 15px;">
                        CA 2
                        ...
                        <a class="btn btn-warning" style="margin-top: 60px;" target="_blank" href="{{ url('teacher/my_ca_result/print?class_id=' . Request::get('class_id') . '&exam_id=' . Request::get('exam_id') . '&student_id=' . $student->id) }}">C.A Result</a>
                        <br>
                        <a class="btn btn-success" style="margin-top: 60px;" target="_blank" href="{{ url('teacher/my_exam_result/print?class_id=' . Request::get('class_id') . '&exam_id=' . Request::get('exam_id') . '&student_id=' . $student->id) }}">Exam Result</a>
                        <br> <br>
                        @if ($getSingleExamName->name == 'Term 3')
                        <a class="btn btn-info btn-sm" style="background: #ec24a0; color: white;" target="_blank" href="{{ url('teacher/cumulative_exam_result/print?class_id=' . Request::get('class_id') . '&exam_id=' . Request::get('exam_id') . '&student_id=' . $student->id) }}">Print Cumulative Result</a>
                        @endif
