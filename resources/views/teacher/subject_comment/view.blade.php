                  ...
                  <div class="row">
                    ...
                    <div class="form-group col-md-3">
                     ...
                     <div class="form-group col-md-3">
                        ...
                        <a href="{{ route('examinations.subject_comment') }}" class="btn btn-success" style="margin-top: 32px;">Refresh</a>
                     </div>
                  </div>
               </div>
            </form>
                                       ...
                                       <form action="" method="POST" class="SubmitForm" id="SubmitForm">
                                          ...
                                          <tr>
                                             ...
                                             <td style="min-width: 250px;">
                                                ...
                                                <a href="{{ url('teacher/examinations/print_nursery_goals?exam_id=' . Request::get('exam_id') . '&student_id=' . $student->id) }}" class="btn btn-sm btn-warning" style="margin-top:30px;" target="_blank">View Result</a>
...
////FOR MULTIPLE SAVE BUTTON
   $(document).ready(function() {
        ...
        $(document).on('click', '.SaveSingleSubject', function(e) {
            ...
            $.ajax({
                type: "POST",
                url: "{{ url('teacher/single_submit_subject_comment') }}",
                data: {
                "_token": "{{ csrf_token() }}",
                // id: id,
                student_id: student_id,
