...
<div class="content-wrapper">
   ...
   <section class="content-header">
      <div class="container-fluid">
         <div class="row mb-2">
            <div class="col-sm-6">
               <h1>{{ $getStudent->name }} {{ $getStudent->last_name }} {{ $getStudent->other_name }} Attendance <span style="color: blue;">(Total: {{ $getRecord->total() }})</span></h1>
            </div>
         </div>
      </div>
                          ...
                          <div class="row">
                            ...
                            <div class="form-group col-md-2">
                             ...
                             <div class="form-group col-md-2">
                                ...
                                <a href="{{ route('parent.student.attendance', [$getStudent->id]) }}" class="btn btn-success" style="margin-top: 32px;">Refresh</a>
                             </div>
