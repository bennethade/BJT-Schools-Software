    ...
    <div class="container-fluid">
      <div class="row mb-2">
        ...
        <div class="col-sm-6" style="text-align: right;">
          <a href="{{ route('parent.suggestion.add') }}" class="btn btn-primary">Make a Suggestion/Feedback</a>
              ...
              <div class="card-body">
                <div class="row">
                  ...
                  <div class="form-group col-md-3">
                    ...
                    <a href="{{ route('parent.suggestion.list') }}" class="btn btn-success" style="">Refresh</a>
                  </div>
