                                            ...
                                            @else
                                                @if ($getSingleExamName->name == 'Term 3')
                                                    <td style="min-width: 400px;">
                                                        <a href="{{ url('parent/my_ca_result/print?class_id=' . Request::get('class_id') . '&exam_id=' . Request::get('exam_id') . '&student_id='.$value->id) }}" class="btn btn-warning btn-sm" style="float: right; margin-left: 5px;" target="_blank" >C.A Result</a>
                                                        ...
                                                        <a class="btn btn-info btn-sm" style="background: #ec24a0; color: white;" target="_blank" href="{{ url('parent/cumulative_exam_result/print?class_id=' . Request::get('class_id') . '&student_id='.$value->id) }}">Print Cumulative Result</a>
                                                    </td>
                                                @else
                                                    <td style="min-width: 50px;">
