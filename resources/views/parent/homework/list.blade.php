...
<div class="content-wrapper">
  ...
  <section class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-12">
          <h1> <span style="color: blue;">{{ $getStudent->name }} {{ $getStudent->last_name }} {{ $getStudent->other_name }}</span> Homework List</h1>
        </div>
              ...
              <div class="card-body">
                <div class="row">
                  ...
                  <div class="form-group col-md-2">
                    ...
                    <a href="{{ route('parent.student.homework',[$getStudent->id]) }}" class="btn btn-success" style="margin-top: 32px;">Refresh</a>
                  </div>
