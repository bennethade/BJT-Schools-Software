                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td style="min-width: 50px;">
                                                <a class="btn btn-sm" style="background: #ec24a0; color: white;" target="_blank" href="{{ url('parent/my_student_fees/print?exam_id=' . Request::get('exam_id') . '&student_id='.$value->id) }}">View Invoice</a>
                                            </td>
                                        </tr>
                                        @endforeach
                                    </tbody>
