                ...
                <table class="table-bg score-table" style="width:100%; border: 1px solid #000; font-weight:bold;">
                    <thead>
                        <tr>
                            ...
                            <th rowspan="2" class="score-table" scope="col" style="transform: rotate(-90deg);">EXAM <br> (70%) </th>
                        ...
                        <tr>
                            <th class="score-table">CA1 <br/> 15%</th>
                            <th class="score-table">CA2 <br> 15%</th>
                            <!--<th class="score-table">CA3 <br> 10%</th>-->
                    ...
                    @foreach ($getExamMark as $exam)
                        @php
                            ...
                            {
                                $totalMark = $exam['ca1']  + $exam['ca2'] + $exam['ca3'] + $exam['exam'];
                            }
                        ...
                        <tr>
                            ...
                            <!--<td class="td score-table">{{ $exam['ca3'] }}</td>-->
