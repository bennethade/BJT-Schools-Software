                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="form-group col-md-3">
                                ...
                                <a href="{{ route('student.cbt.list') }}" class="btn btn-success" style="margin-top: 32px;">Refresh</a>
                            </div>
                        </div>
                    </div>
                </form>
                                ...
                                <table class="table table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        @empty
                                            <tr>
                                                <td colspan="100%">
                                                    <p style="color: red;">No pending CBT Found for the chosen class and term</p>
                                                </td>
                                            </tr>
                                        @endforelse 
                                    </tbody>
