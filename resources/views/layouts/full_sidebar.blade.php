  ...
  <div class="sidebar">
    ...
    <nav class="mt-2">
      ...
      <li class="nav-item @if(Request::segment(2) == 'fees_collection') menu-is-opening menu-open @endif">
        ...
        {{-- <li class="nav-item">
          <a href="{{ url('admin/fees_collection/fees_breakdown') }}"
          class="nav-link @if(Request::segment(3) == 'fees_breakdown') active @endif">
          <i class="far fa-circle nav-icon"></i>
          <p>Fees Breakdown</p>
          </a>
        </li> --}}
        ...
        {{-- <li class="nav-item">
          <a href="{{ url('admin/fees_collection/collect_fees_repot') }}"
          class="nav-link @if(Request::segment(3) == 'collect_fees_repot') active @endif">
          <i class="far fa-circle nav-icon"></i>
    ...
    My Students
      ...
      {{-- <li class="nav-item @if(Request::segment(2) == 'cbt') menu-is-opening menu-open @endif">
        ...
        <ul class="nav nav-treeview">
          ...
          <li class="nav-item @if(in_array(Request::segment(2) == 'cbt' || Request::segment(3), ['subject_teacher_cbt_questions', 'assigned_subject_cbt', 'subject_cbt_scores'])) menu-is-opening menu-open @endif">
            <a href="#" subject="nav-link @if(in_array(Request::segment(2) == 'cbt' || Request::segment(3), ['subject_teacher_cbt_questions', 'assigned_subject_cbt', 'subject_cbt_scores'])) active @endif">
              <i class="far fa-circle nav-icon"></i>
              <p>
                Subject Teacher CBT <i class="fas fa-angle-left right"></i>
              </p>
            </a>
            <ul class="nav nav-treeview">
              <li class="nav-item">
              ...
              <li class="nav-item">
                <a href="{{ url('teacher/cbt/subject_cbt_scores') }}"
                  ...
                  <i class="far fa-dot-circle nav-icon"></i>
                  <p>Subject CBT Scores</p>
                </a>
              </li>
            </ul>
          </li>

          <li class="nav-item @if(in_array(Request::segment(2) == 'cbt' || Request::segment(3), ['class_teacher_cbt_questions', 'assigned_class_cbt', 'class_cbt_scores'])) menu-is-opening menu-open @endif">
            <a href="#" class="nav-link @if(in_array(Request::segment(2) == 'cbt' || Request::segment(3), ['class_teacher_cbt_questions', 'assigned_class_cbt', 'class_cbt_scores'])) active @endif">
              <i class="far fa-circle nav-icon"></i>
              <p>
                Class Teacher CBT
                <i class="fas fa-angle-left right"></i>
